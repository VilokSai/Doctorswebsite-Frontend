...
function Doctorr() {
  ...
  const handleAddDoctor = (newDoctor) => {
    ...
    axios.post(' http://13.201.74.203:5000/doctors', newDoctor)
      .then((response) => {
  ...
  const handleDeleteDoctor = (doctorId) => {
    ...
    axios.delete(`http://13.201.74.203:5000/doctors/${doctorId}`)
      .then(() => {
  ...
  const handleEditDoctor = (editedDoctor) => {
    ...
    axios.put(`http://13.201.74.203:5000/doctors/${editedDoctor.id}`, editedDoctor)
      .then(() => {
